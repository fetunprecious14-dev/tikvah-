      ...
      <section className="bg-primary text-primary-foreground">
        <div className="mx-auto max-w-[1220px] px-5 py-16 sm:px-8 sm:py-24">
          ...
          <p className="mt-7 max-w-xl text-[17px] leading-7 text-primary-foreground/75">
            If you may hurt yourself or someone else, or cannot stay safe, please connect with a person who can be with you right now. You do not have to explain everything.
          </p>
        </div>
      </section>
      <section className="mx-auto max-w-[1220px] px-5 py-16 sm:px-8 sm:py-24">
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-border bg-card p-7">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground">Move toward another person, unlock your door, or ask someone you trust to stay with you. You can simply say: "I need company."</p>
          </div>
        </div>
        <div className="mx-auto mt-16 max-w-2xl border-t border-border pt-10">
          ...
          <p className="mt-4 text-[15px] leading-7 text-muted-foreground">
            ...
            , or find{' '}
            <Link href="/professionals" className="text-primary underline underline-offset-4" data-testid="link-crisis-professionals">
              non-emergency professional help
            </Link>
            . A member of our team will read messages sent through your dashboard and write back. Support does not have to start perfectly.
          </p>
