...
export const config = {
  ...
  /** Telegram chat id every new-message alert is sent to; skipped (logged) when unset together with TELEGRAM_BOT_TOKEN. */
  adminAlertTelegramChatId: process.env.TELEGRAM_CHAT_ID ?? null,
